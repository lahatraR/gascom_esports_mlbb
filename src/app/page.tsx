...
import type { GameMode, DraftArchetype, SeriesMode } from '@/types/draft';
import {
  ARCHETYPE_ICON,
  ARCHETYPE_LABELS,
...
export default function Home() {
  ...
  useEffect(() => {
    loadHeroPool().then(() => {
      // If URL contains draft state, jump directly to draft
      ...
      >
        ...
        <div className="relative z-10 flex flex-col flex-1 min-h-screen items-center justify-center px-4 py-10 sm:py-14">
          ...
          <div className="flex flex-col items-center text-center mb-10 sm:mb-14">
            ...
            <div style={{ filter: 'drop-shadow(0 0 28px rgba(200,50,22,1)) drop-shadow(0 0 72px rgba(120,20,10,0.60))', position: 'relative' }}>
              <Image
                src={`${BASE}/ges-logo.png`}
          ...
          <div className="w-full max-w-4xl flex flex-col items-center gap-6 sm:gap-8">
            ...
            <div className="flex flex-col items-center gap-2">
              ...
              <div style={{ height: 1, width: 60, background: 'linear-gradient(to right, transparent, rgba(124,26,15,0.70), transparent)' }} />
            </div>
                ...
                return (
                  ...
                  >
                    ...
                    <div
                      ...
                      style={{ fontSize: 'clamp(15px, 2.8vw, 20px)', color: isHovered ? '#ffffff' : 'rgba(230,210,200,0.92)' }}
                    >
                      {mode.label}
                    </div>
                    <div
                      className="mt-1 font-medium tracking-wider transition-colors duration-300"
                      style={{ fontSize: 'clamp(9px, 1.3vw, 11px)', color: isHovered ? 'rgba(220,130,90,0.95)' : 'rgba(160,80,55,0.80)' }}
                    >
                      {mode.subLabel}
                    </div>
                    <div
                    ...
                    <p
                      ...
                      style={{ fontSize: 'clamp(10px, 1.4vw, 12px)', color: isHovered ? 'rgba(180,130,110,0.90)' : 'rgba(120,75,55,0.75)', maxWidth: 240 }}
                    >
                      {mode.desc}
                    </p>
                    <div
                      ...
                      style={{
                        ...
                        background: isHovered ? 'linear-gradient(135deg, #8c1e10, #5a1208)' : 'rgba(124,26,15,0.22)',
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 w-full max-w-2xl">
            {sides.map((side) => (
              <button
                ...
                style={{ background: side.bg, borderColor: side.border, boxShadow: `0 0 32px ${side.glow}`, padding: 'clamp(20px, 3vw, 32px)' }}
              >
                <div className="flex items-center gap-3 mb-4">
                  <span style={{ fontSize: '2rem' }}>{side.emoji}</span>
                  <div>
                    <div className="font-display tracking-[0.18em] text-white" style={{ fontSize: 'clamp(15px, 2.5vw, 20px)' }}>{side.label}</div>
                    <div className="text-[10px] font-medium tracking-wider mt-0.5" style={{ color: side.accent }}>{side.sub}</div>
                  </div>
                </div>
        ...
        <div className="relative z-10 flex flex-col flex-1 min-h-screen items-center justify-center px-4 py-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 w-full max-w-xl">
            <button
              ...
              style={{ background: 'rgba(20,40,20,0.35)', borderColor: 'rgba(74,222,128,0.45)', boxShadow: '0 0 24px rgba(74,222,128,0.12)', padding: 'clamp(24px,3vw,36px)' }}
            >
            ...
            <button
              ...
              className="flex flex-col items-center rounded-2xl border cursor-pointer transition-all duration-300 hover:scale-[1.02]"
              style={{ background: 'rgba(15,10,30,0.35)', borderColor: 'rgba(124,26,15,0.45)', boxShadow: '0 0 24px rgba(124,26,15,0.12)', padding: 'clamp(24px,3vw,36px)' }}
            >
              <span style={{ fontSize: '2.5rem' }}>🎲</span>
              <span className="font-display tracking-widest text-white mt-3" style={{ fontSize: 'clamp(14px,2.2vw,18px)' }}>
                NON, draft libre
            ...
            {archetypes.map((arch) => {
              ...
              return (
                <button
                  ...
                  style={{ background: ac.bg, borderColor: ac.border, boxShadow: `0 0 24px ${ac.glow}`, padding: 'clamp(16px,2.5vw,24px)' }}
                >
                  ...
                  <p className="text-[11px] text-slate-400 leading-relaxed mb-3">{ARCHETYPE_DESCRIPTION[arch]}</p>
                  <div className="flex flex-col gap-1 mt-auto">
                    <span className="text-[9px] font-bold" style={{ color: '#4ade80' }}>✓ Bat : {beats}</span>
                    <span className="text-[9px] font-bold" style={{ color: '#f87171' }}>✗ Perdu contre : {loses}</span>
                  </div>
                </button>
              );
            })}
    ...
    >
      ...
      <div className="relative z-10 flex flex-col flex-1 min-h-screen">
        ...
        >
          ...
          <div style={{ filter: 'drop-shadow(0 0 16px rgba(180,40,20,0.85)) drop-shadow(0 0 40px rgba(120,20,10,0.45))' }}>
            <Image
              src={`${BASE}/ges-logo.png`}
              alt="Gascom Esports Logo"
              width={90} height={106}
        ...
        >
          {/* Left: mini logo + back button + mode badge */}
          <div className="flex items-center gap-2 shrink-0">
            <Image
              src={`${BASE}/ges-logo.png`}
              alt="GES"
              width={28} height={33}
              style={{ width: 26, height: 'auto', filter: 'drop-shadow(0 0 5px rgba(160,32,14,0.8))' }}
            />
            <button
          ...
          {/* Center: series selector */}
          <div className="flex items-center gap-0.5 rounded-lg p-1 border"
        ...
        <footer
          ...
          style={{ background: 'rgba(3,3,4,0.92)', borderColor: 'rgba(124,26,15,0.25)' }}
        >
          <span className="text-[10px] text-slate-600">
            ...
            {' '}·{' '}
            <span className="text-slate-700">Patch {TIER_LIST_PATCH} ({TIER_LIST_DATE})</span>
            {' '}·{' '}
            <span className="text-slate-700 text-[9px]">Press / to search · 1-9 quick-select · Ctrl+Z undo</span>
          </span>
          <div className="flex items-center gap-2 opacity-60">
            <Image src={`${BASE}/ges-logo.png`} alt="GES" width={16} height={19} style={{ width: 16, height: 'auto' }} />
            <span className="text-[10px] font-display tracking-widest" style={{ color: 'rgba(180,60,40,0.8)' }}>
              GASCOM ESPORTS
            </span>
          </div>
        </footer>
